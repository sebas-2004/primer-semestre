...
# 8. Calcular cantidad partidos por equipo
...
# Generar una lista aleatoria  para indicar si el equipo juega de local o visitante
...
# Inicializar lista para contar cantidad de partidos de cada equipo
...
# Imprimir la cantidad de partidos de cada equipo en la liga
